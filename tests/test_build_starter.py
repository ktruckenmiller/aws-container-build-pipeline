...
def test_simple_build_event(monkeypatch):
    ...
    all_build_steps = build_obj.get_build_steps()
    print all_build_steps
    assert all_build_steps[1]['codebuild_project'] == "arn:aws:codebuild:us-west-2:601394826940:project/docker-friend"

    state_machine = step_obj.build_state_machine(all_build_steps)
    ...
    # def mockreturn_csm(name, roleArn, definition):
    #     return {
    #         'ResponseMetadata': {
    #             'HTTPStatusCode': 200
    #         },
    #         'stateMachineArn': 'arn-for-state-machine'
    #     }
    # monkeypatch.setattr(sfn, 'create_state_machine', mockreturn_csm)

    print state_machine['name']
    print state_machine['roleArn']
    pprint(json.loads(state_machine['definition']))
    ...
    #
    # def mockreturn_se(stateMachineArn, input):
    #     return {
    #         'ResponseMetadata': {
    #             'HTTPStatusCode': 200
    #         },
    ...
    #     }
    #
    # monkeypatch.setattr(sfn, 'start_execution', mockreturn_se)
    # # start execution
